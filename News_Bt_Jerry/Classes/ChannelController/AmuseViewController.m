...
@interface AmuseViewController ()<UITableViewDataSource, UITableViewDelegate>
...
- (void)loadData {
	[HomeData loadAmuseModelsSuccess:^(NSURLSessionDataTask * _Nonnull task, NSArray *articleData) {
