...
@interface IntelligentViewController ()<UITableViewDataSource, UITableViewDelegate>
...
- (void)loadData {
	[HomeData loadIntelModelsSuccess:^(NSURLSessionDataTask * _Nonnull task, NSArray *articleData) {
