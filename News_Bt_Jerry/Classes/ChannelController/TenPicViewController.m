...
@interface TenPicViewController ()<UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, strong) UITableView	*tableView;
@property (nonatomic, strong) NSArray		*articleData;
@end

@implementation TenPicViewController
...
- (void)loadData {
	[HomeData loadTenModelsSuccess:^(NSURLSessionDataTask * _Nonnull task, NSArray *articleData) {
